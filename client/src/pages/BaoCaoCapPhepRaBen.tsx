...
export default function BaoCaoCapPhepRaBen() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Sort by permit time (newest first)
      result.sort((a, b) => {
        if (a.permitTime === "-" && b.permitTime === "-") return 0;
        if (a.permitTime === "-") return 1;
        if (b.permitTime === "-") return -1;
        return new Date(b.permitTime).getTime() - new Date(a.permitTime).getTime();
      });
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-100">
                  ...
                  <TableHead className="text-center font-semibold">Biển số</TableHead>
                  <TableHead className="text-center font-semibold">Tên đơn vị</TableHead>
                  <TableHead className="text-center font-semibold">Tên luồng tuyến</TableHead>
                  <TableHead className="text-center font-semibold">Thời gian vào bến</TableHead>
                  <TableHead className="text-center font-semibold">Thời gian cấp phép ra bến</TableHead>
                  <TableHead className="text-center font-semibold">Người cấp phép ra bến</TableHead>
                  <TableHead className="text-center font-semibold">Thời gian ra bến</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {isLoading ? (
